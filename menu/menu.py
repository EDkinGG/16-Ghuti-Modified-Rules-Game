...
def score():
    while True:
        ...
        OPTIONS_TEXT = get_font(45).render("This is the HIGH SCORE screen.", True, "white")
...
def main_menu():
    while True:
        ...
        SCORE_BUTTON = Button( pos=(640, 400), 
                            text_input="HIGH SCORE", font=get_font(75), base_color="#d7fcd4", hovering_color="orange")
